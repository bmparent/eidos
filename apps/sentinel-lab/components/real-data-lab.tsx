    ...
    <section className="real-data-page" aria-labelledby="real-data-title">
      ...
      <div className="real-workspace">
        ...
        <aside className="run-lock-panel">
          ...
          <p className="token-note">Kept in memory for this page only. Readiness checks your settings. Compute startup and dataset access are verified after launch. <a href="https://eidos-works.com/lab/access" target="_blank" rel="noreferrer">Message Brent for an access code</a>.</p>
