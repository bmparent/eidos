...
type Tab = "lab" | "evidence" | "gates" | "compare";
    ...
    <div className="site-shell">
      <header className="site-header">
        ...
        <nav className={menuOpen ? "primary-nav open" : "primary-nav"} aria-label="Primary navigation">
          {(["lab", "evidence", "gates", "compare"] as Tab[]).map((item) => <button key={item} className={tab === item ? "active" : ""} onClick={() => navigate(item)}>{item}</button>)}
        </nav>
      ...
      <main>
        <section className="hero">
          <div className="hero-index">GP / 01</div>
      ...
      <footer className="site-footer"><span>EIDOS-GP-v1-2026-09-01</span><p>ENGINEERING SMOKE DOES NOT ADVANCE PROOF GATES.</p><span>PAST-ONLY / LABEL-ISOLATED</span></footer>
