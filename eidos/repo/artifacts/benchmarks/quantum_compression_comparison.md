...
| --- | --- | ---: | ---: | ---: | ---: | ---: | ---: | --- |
| quantum_normal | eidos_residual_codec_gzip | 1.474 | 0.004591 | 0 | 1 | 0 | - | Predictive Eidos token stream with Sentinel proxy; proxy warmup=8. |
...
| quantum_decoherence_drift | eidos_residual_codec_gzip | 1.456 | 0.003999 | 0.9412 | 0.6667 | 0.7805 | 0 | Predictive Eidos token stream with Sentinel proxy; proxy warmup=8. |
...
| quantum_syndrome_burst | eidos_residual_codec_gzip | 1.206 | 0.004154 | 1 | 1 | 1 | 0 | Predictive Eidos token stream with Sentinel proxy; proxy warmup=8. |
...
| quantum_readout_bias_shift | eidos_residual_codec_gzip | 1.139 | 0.00278 | 0.7302 | 0.9583 | 0.8288 | 0 | Predictive Eidos token stream with Sentinel proxy; proxy warmup=8. |
...
| crypto_downgrade_exfiltration_risk | eidos_residual_codec_gzip | 1.337 | 0.001581 | 0.5647 | 1 | 0.7218 | 0 | Predictive Eidos token stream with Sentinel proxy; proxy warmup=8. |
...
| binary_high_entropy_blob | eidos_residual_codec_gzip | 1.117 | 0.007848 | 0.9796 | 1 | 0.9897 | 0 | Predictive Eidos token stream with Sentinel proxy; proxy warmup=8. |
