export const SCENARIOS = {
  ...
  primordial_soup: { random: 0, anomaly: 0.02, preset: { abiogenesis_enabled: true, primordial_bloom_enabled: true, abiogenesis_seed_count: 32, primordial_bloom_seed_count: 56 }, field: { nutrient: 0.85, toxicity: 0.04 } },
  ...
  dead_world: { random: 0, anomaly: 0, preset: { abiogenesis_enabled: false, near_extinction_recovery_enabled: false, viability_enabled: false } },
};
